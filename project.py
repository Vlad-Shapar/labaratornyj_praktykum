...
btn3 = Button(root)
btn3.configure(bg = 'gray', fg = 'white', text = 'відкрити список банків (JSON)', command = createJSON)
btn3.place(x = 55, y = 80, width = 200, height = 30)

btn4 = Button(root)
btn4.configure(bg = 'gray', fg = 'white', text = 'відкрити  курс(JSON)', command = create_JSON)
